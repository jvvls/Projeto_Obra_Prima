...
function renderGrid(obras) {
  ...
  obras.forEach(obra => {
    ...
    const imgSrc = Array.isArray(obra.anexos)
      ? (obra.anexos.find(a => a.tipo === "imagem")?.url || '../assets/images/Logo2.png')
      : '../assets/images/Logo2.png';

    card.innerHTML = `
      <img src="${imgSrc}" alt="obra" onerror="this.onerror=null; this.src='../assets/images/Logo2.png'">
      <h3>${obra.titulo}</h3>
  ...
  detalhesContent.innerHTML = `
    ...
    <div class="tab-content active" id="resumo">
      <div class="detalhes-card">
        <img src="${obra.anexos?.find(a => a.tipo === "imagem")?.url || '../assets/images/Logo2.png'}" />
